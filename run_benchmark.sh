...
#
# Usage:
#   ./run_benchmark.sh                  # run all tasks, both conditions
...
# Maps a session CWD to its Claude Code project dir (replaces / and _ with -)
cwd_to_project_dir() {
    local REAL_CWD
...
run_session() {
    ...
    if [ "$CONDITION" = "baseline" ]; then
        ...
        # Three turns: activate hook → prompt → accept refined prompt
